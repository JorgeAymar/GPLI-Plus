  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
        <div>
          <h2 className="mb-2 text-sm font-semibold">Activos habilitados para reserva</h2>
        ...
        <div>
          <h2 className="mb-2 text-sm font-medium opacity-60">Habilitar activo para reserva</h2>
